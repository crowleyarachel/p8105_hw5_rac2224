...
plot2 = 
  truebeta %>%
    ...
    ggplot(aes(x = beta_1, y = estimate_mean)) + geom_point(alpha = .5) +
      labs(
        title = "Relationship between the average estimate of beta and true beta",
...
plot3 = 
  truebeta %>% 
    ...
    ggplot(aes(x = beta_1, y = estimate_mean)) + geom_point(alpha = .5) + 
      labs(
        title = "Relationship between average estimate of beta and true beta when null is rejected",
        x = "True value of beta",
        y = "Average estimate of beta",
        caption = "Data from 10,000 simulations"
      )
